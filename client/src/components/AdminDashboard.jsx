...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    let numberOfTotalReturnBooks = allBorrowedBooks.filter(
      (book) => book.returnDate !== null
    )
    setTotalBorrowedBooks(numberOfTotalBorrowedBooks.length)
    setTotalReturnedBooks(numberOfTotalReturnBooks.length)
      ...
      <main className="relative flex-1 p-6 pt-28">
        ...
        <div className="flex flex-col-reverse xl:flex-row">
          ...
          <div className="flex-[2] flex-col gap-7 lg:flex-row flex lg:items-center xl:flex-col justify-between xl:gap-20 py-5">
            <div className="xl:flex-[4] flex items-start w-full content-center">
          ...
          <div className="flex flex-[4] flex-col gap-7 lg:gap-7 lg:py-7 justify-between xl:min-h-[85.5vh]">
            <div className="flex flex-col-reverse lg:flex-row gap-7 flex-[4]">
              ...
              <div className="flex flex-col lg:flex-row flex-1">
                <div className="fle flex-col lg:flex-row flex-1 items-center justify-center">
                  <div className="bg-white p-5 rounded-lg shadow-lg h-full flex flex-col justify-center items-center gap-4">
                    ...
                    <p className="text-gray-600 text-sm 2xl:text-base text-center">Welcone to your admin dashboard. Here you can change all the settings</p>
                  </div>
                </div>
              </div>
            </div>
