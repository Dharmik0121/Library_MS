...
//   await axios
//     .get("https://library-ms-backend.onrender.com/api/v1/book/all", {
...
export const fetchAllBooks = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get(
      "https://library-ms-backend.onrender.com/api/v1/book/all",
      {
        withCredentials: true,
      }
    );
...
export const addBook = (data) => async (dispatch) => {
  ...
  await axios
    .post(
      "https://library-ms-backend.onrender.com/api/v1/book/admin/add",
      data,
      {
        withCredentials: true,
        headers: {
...
export const updateBookQuantity = (bookId, newQuantity) => async (dispatch) => {
  ...
  try {
    const res = await axios.put(
      `https://library-ms-backend.onrender.com/api/v1/book/update/${bookId}`,
